...
function PublicOnly({ children }: { children: React.ReactNode }) { const { user, loading } = useAuth(); if (loading) return <div className="page-loader"><span className="spinner" /> Loading CRM360...</div>; return user ? <Navigate to="/app" replace /> : children }
